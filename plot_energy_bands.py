...
k_2 = (Lambda + np.sqrt(Lambda**2
                             + 4*gamma*mu)) / (2*gamma)
# k_values = np.append(np.linspace(0.7*k_F, 0.73*k_F, 100, endpoint=False),
#                      [np.linspace(0.73*k_F, 1.38*k_F, 100, endpoint=False),
#                       np.linspace(1.38*k_F, 1.42*k_F, 100)])
k_values = np.append(np.linspace(0.99*k_1, 1.01*k_1, 100, endpoint=False),
                     [np.linspace(1.01*k_1, 0.99*k_2, 100, endpoint=False),
                      np.linspace(0.99*k_2, 1.01*k_2, 100)])
